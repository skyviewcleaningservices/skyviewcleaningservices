...
const heroImages = [
  ...
  },
  {
    ...
    alt: "Deep cleaning professional with equipment"
  },
  {
    src: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
  ...
  {
    src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    alt: "Clean modern living room after professional cleaning"
  },
  {
    src: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    alt: "Professional cleaning staff with modern equipment"
  }
];
          ...
          <div className="flex justify-between items-center h-28">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button
                ...
                className="bg-indigo-600 dark:bg-indigo-500 text-white px-6 py-2 rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-600"
              >
                Book Now
              </button>
              <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href="#services"
                  className="border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-white hover:text-indigo-600 dark:hover:text-indigo-700 transition-colors text-center"
                >
                  Our Services
                </a>
              </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Professional Team</h3>
                    <p className="text-gray-600 dark:text-gray-300">Trained and experienced cleaning professionals</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Eco-Friendly Products</h3>
                    <p className="text-gray-600 dark:text-gray-300">Safe and environmentally friendly cleaning solutions</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Satisfaction Guaranteed</h3>
      ...
      <section className="py-12 bg-indigo-600 dark:bg-indigo-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex justify-center items-center mb-6">
            ...
            <span className="ml-2 text-indigo-200 dark:text-indigo-300">(2,847 reviews)</span>
          </div>

          <p className="text-xl mb-8 text-indigo-100 dark:text-indigo-200 max-w-3xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">skyviewcleaningservices@gmail.com</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-indigo-600 dark:bg-indigo-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
