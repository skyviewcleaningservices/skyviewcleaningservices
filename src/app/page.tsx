          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3 group">
              ...
              <div className="leading-tight">
                ...
                <p className="hidden sm:block text-[11px] font-medium text-indigo-600 dark:text-indigo-400 uppercase tracking-widest -mt-0.5">Cleaning Services</p>
              </div>
            </div>
            ...
            <div className="flex md:hidden items-center gap-2">
              ...
              <button
                onClick={() => setIsModalOpen(true)}
                className="text-sm font-semibold bg-gradient-to-r from-indigo-600 to-violet-600 text-white px-3.5 py-2 rounded-full shadow-sm shadow-indigo-600/30 whitespace-nowrap"
              >
                Book Now
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 left-2 sm:-left-6 bg-white dark:bg-slate-800 rounded-xl shadow-xl px-5 py-4 flex items-center gap-3">
